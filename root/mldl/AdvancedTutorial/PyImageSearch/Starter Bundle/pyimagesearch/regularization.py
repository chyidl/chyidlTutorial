...
from sklearn.linear_model import SGDClassifier # including Loss functions, Number of epochs, Learning rate, Regularization terms
...
# loop over our set of regularizers, including no regularization
for r in (None, "l1", "l2"):
