...
def receiveMessageTest(fromAddr, fromPasswd):
    """
    fromAddr:
    fromPasswd:
    """
    email = ChyiEmail(fromAddr, fromPasswd)
    email.receiveEmail()  # receive massage


if __name__ == '__main__':
    env_dist = os.environ
    fromAddr = env_dist.get('Email_receive')
    fromPasswd = env_dist.get('Email_receive_password')
    receiveMessageTest(fromAddr, fromPasswd)
