...
# To consumer latest messsages and auto-commit offsets
...
# consumer earliest available messages, don't commit offsets
...
# consume msgpack
KafkaConsumer(value_deserializer=msgpack.unpack)
